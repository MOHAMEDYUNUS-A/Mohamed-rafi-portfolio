...
const CreatorCard = ({ category, index }) => (
  <div 
    ...
    className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:scale-[1.02] hover:border-violet-400/30 hover:shadow-[0_20px_50px_rgba(139,92,246,0.15)] transition-all duration-500 group flex flex-col justify-between"
  >
    <div>
      <div className="flex justify-between items-start mb-6">
        <span className="text-4xl p-3 bg-white/5 rounded-2xl group-hover:bg-gradient-to-br group-hover:from-indigo-500/15 group-hover:via-violet-500/15 group-hover:to-cyan-400/15 group-hover:scale-110 transition-all duration-300">
          {category.icon}
        </span>
      ...
      <h3 className="text-white text-xl md:text-2xl font-black mb-3 tracking-tight group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-indigo-400 group-hover:via-violet-400 group-hover:to-cyan-400 transition-colors">
        {category.title}
      </h3>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div data-aos="fade-up" data-aos-delay="400" className="mt-16 flex justify-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-indigo-500 via-violet-500 to-cyan-400 text-black font-bold text-lg hover:scale-105 hover:shadow-[0_0_30px_rgba(139,92,246,0.4)] transition-all duration-500 group"
          >
